...
Without a Linux desktop to try them on, writing Desktop files (see
`desktop_entry_points`) becomes a bit of a guessing game.

https://tart.run/integrations/vm-management/#creating-a-linux-vm-image-from-scratch
