...
``pyproject.toml``, `polycotylus` will read package metadata from there instead
of the usual ``project`` section.
...
possible on Fedora. If you get some kind of error like the one below, it means
that your version constraints are too fussy and you will need to relax them or
you can't build for that Fedora release. ::
