...
@pytest.mark.parametrize("Ubuntu", [polycotylus.Ubuntu2404, polycotylus.Ubuntu2610])
...
def test_ubrotli():
    ...
    for self in [
        ...
        polycotylus.Ubuntu2610(Project.from_root(shared.ubrotli), architecture="amd64"),
    ]:
        self.generate()
    ...
    assert json.loads((shared.ubrotli / ".polycotylus/artifacts.json").read_bytes()) == [
        ...
        },
        {
            ...
            "architecture": "amd64",
            "package_type": "main",
            "path": ".polycotylus/ubuntu/26.10/python3-ubrotli_0.1.0-1_amd64.deb",
            "signature_path": None,
        }
    ]
