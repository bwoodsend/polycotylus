    ...
    assert json.loads((shared.kitchen_sink / ".polycotylus/artifacts.json").read_bytes()) == [
        {
            ...
            "architecture": "x86_64",
            "package_type": "doc",
            "path": ".polycotylus/alpine/3.24/x86_64/py3-99---s1lly---name---packag3--x--y--z-doc-1.2.3.4-r1.apk",
            "signature_path": None
        }, {
            "distribution": "alpine",
            "tag": "3.24",
            "architecture": "x86_64",
            "package_type": "main",
            "path": ".polycotylus/alpine/3.24/x86_64/py3-99---s1lly---name---packag3--x--y--z-1.2.3.4-r1.apk",
            "signature_path": None
        }, {
            "distribution": "alpine",
            "tag": "3.24",
            "architecture": "x86_64",
            "package_type": "pyc",
            "path": ".polycotylus/alpine/3.24/x86_64/py3-99---s1lly---name---packag3--x--y--z-pyc-1.2.3.4-r1.apk",
            "signature_path": None
        }, {
            "distribution": "alpine",
            "tag": "edge",
