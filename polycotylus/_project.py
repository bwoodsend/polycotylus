...
trove_to_spdx = json.loads((resources.files("polycotylus") / "trove-spdx-licenses.json").read_bytes())
spdx_osi_approval = json.loads((resources.files("polycotylus") / "spdx-osi-approval.json").read_bytes())
